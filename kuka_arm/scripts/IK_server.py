...
def handle_calculate_IK(req):
    ...
    with open("./ee_errors.csv","a") as csvfile:
        writer = csv.DictWriter(csvfile, ["ee_x","ee_y","ee_z","ee_calc_x","ee_calc_y","ee_calc_z","ee_offset_x","ee_offset_y","ee_offset_z", "ee_offset","theta1","theta2","theta3","theta4","theta5","theta6"])
        writer.writeheader()
	    ...
	    #
            ...
            for x in xrange(0, len(req.poses)):
               ...
               # roll, pitch, yaw = end-effector orientation
                ...
                py_e = abs(py-FK[1,3])
                pz_e = abs(pz-FK[2,3])
                pz_offset = sqrt(px_e**2 + py_e**2 + pz_e**2)
           
                writer.writerow({"ee_x":px,"ee_y":py,"ee_z":pz,"ee_calc_x":FK[0,3],"ee_calc_y":FK[1,3],"ee_calc_z":FK[2,3],"ee_offset_x":px_e, "ee_offset_y":py_e,"ee_offset_z":pz_e,"ee_offset":pz_offset,"theta1":theta1,"theta2":theta2,"theta3":theta3,"theta4":theta4,"theta5":theta5,"theta6":theta6})
